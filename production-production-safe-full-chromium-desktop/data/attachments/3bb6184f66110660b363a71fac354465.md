...
- generic [ref=e3]:
        ...
        - generic [ref=e55]:
          - generic [ref=e56]:
            - generic [ref=e57] [cursor=pointer]:
              - 'checkbox "전체 선택 : 1개 상품" [checked] [ref=e58]'
              - img [ref=e60]
              - generic [ref=e61]: "전체 선택 : 1개 상품"
            - button "삭제" [ref=e62] [cursor=pointer]:
              - generic [ref=e63]:
                - img [ref=e64]
                - text: 삭제
          - generic [ref=e65]:
          ...
          - article [ref=e70]:
            ...
            - generic [ref=e75]:
              - generic [ref=e76]:
                - generic [ref=e77]:
                  - button "자유형 스티커" [ref=e78] [cursor=pointer]:
                    - img "자유형 스티커" [ref=e79]
                    - img [ref=e81]
                  - generic [ref=e82]:
                    - heading "자유형 스티커" [level=3] [ref=e83]
                    - paragraph [ref=e84]: 75x75mm
                    - button "이미지 추가" [ref=e85] [cursor=pointer]:
                      - generic [ref=e86]: 이미지 추가
                - button "사이즈 변경" [ref=e88] [cursor=pointer]:
                  - generic [ref=e89]: 사이즈 변경
              - generic [ref=e90]:
                - button "100개" [ref=e93] [cursor=pointer]:
                  - generic [ref=e94]: 100개
                  - img [ref=e95]
                - strong [ref=e96]: 17,700원
            - button "상품 삭제" [ref=e97] [cursor=pointer]:
              - img [ref=e98]
              - generic [ref=e99]: 상품 삭제
        - complementary [ref=e100]:
          - generic [ref=e101]:
            - heading "주문 요약" [level=2] [ref=e103]
            - generic [ref=e104]:
              - generic [ref=e105]:
                - generic [ref=e106]: 합계
                - strong [ref=e107]: 17,700원
              - generic [ref=e108]:
                - button "주문하기 (1)" [ref=e109] [cursor=pointer]:
                  - generic [ref=e110]: 주문하기 (1)
                - paragraph [ref=e111]: 배송비 및 할인은 결제 시 적용됩니다.
    - navigation "네이버 톡톡으로 문의하기" [ref=e112]:
      - link "카카오채널로 문의하기" [ref=e113] [cursor=pointer]:
        ...
        - img [ref=e115]
      - link "네이버 톡톡 으로 문의하기" [ref=e116] [cursor=pointer]:
        ...
        - img [ref=e118]
      - button "이메일로 문의하기" [ref=e119] [cursor=pointer]:
        - generic:
          - generic:
            - generic:
              - img
  ...
  - contentinfo [ref=e122]:
    - generic [ref=e123]:
      - generic [ref=e124]: ⓒ (주)글로픽스. 2026. All rights reserved.
      - generic [ref=e125]:
        - generic [ref=e126]: "판매: sales@musticker.com"
        - link "이용약관" [ref=e127] [cursor=pointer]:
          - /url: /kr/terms-of-use
        - link "개인정보처리방침" [ref=e128] [cursor=pointer]:
          - /url: /kr/privacy-policy
        - button "사업자정보확인" [ref=e129] [cursor=pointer]
        - link "오픈소스 라이선스" [ref=e130] [cursor=pointer]:
          - /url: /kr/open-source-licenses
        - link "회사소개" [ref=e131] [cursor=pointer]:
          - /url: /kr/about
      - generic [ref=e132]:
        - button "1:1문의하기" [ref=e133] [cursor=pointer]
        - link "자주 묻는 질문" [ref=e134] [cursor=pointer]:
          - /url: /kr/faq
```
