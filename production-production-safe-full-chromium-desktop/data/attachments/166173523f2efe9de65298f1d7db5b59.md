...
Locator:  getByTestId('cart-page-row')
Expected: 2
Received: 0
Timeout:  15000ms
...
Call log:
  ...
  - waiting for getByTestId('cart-page-row')
...
+   "[error] Failed to load resource: the server responded with a status of 403 ()",
+   "[error] Failed to load resource: the server responded with a status of 403 ()",
+   "[error] TypeError: Failed to fetch dynamically imported module: https://www.musticker.com/_nuxt/D9_WFP-G.js",
+   "[error] Failed to load resource: the server responded with a status of 403 ()",
+ ]
```
...
+   "403 https://www.musticker.com/_nuxt/cart.ZP3oQOpf.css",
+   "403 https://www.musticker.com/_nuxt/D9_WFP-G.js",
