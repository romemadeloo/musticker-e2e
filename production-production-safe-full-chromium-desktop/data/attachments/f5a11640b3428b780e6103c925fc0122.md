...
- Name: storefront/api/public-api.spec.ts >> storefront public API smoke >> MS-V2-038 anonymous user session API rejects unauthenticated users safely
- Location: tests/e2e/storefront/api/public-api.spec.ts:23:3
