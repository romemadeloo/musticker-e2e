...
- Name: api/public-api.spec.ts >> storefront public API smoke >> MS-V2-036 navigation categories API returns public category data
- Location: tests/e2e/api/public-api.spec.ts:8:3

# Error details

```
Error: 403 https://api.musticker.com/index.php/sys/kr/navigation/categories
