...
- Name: auth/registration.spec.ts >> storefront registration >> MS-V2-085 login entry is reachable from register
- Location: tests/e2e/auth/registration.spec.ts:105:3
...
Locator: getByTestId('auth-register-page')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByTestId('auth-register-page')
