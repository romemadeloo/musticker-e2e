...
Call log:
  - waiting for getByRole('listbox').last().getByText('맞춤 사이즈').first()
...
- generic [ref=e1]:
  - generic [ref=e3]:
      ...
      - generic [ref=e48]:
          ...
          - generic [ref=e53]:
            ...
            - complementary [ref=e82]:
              ...
              - list [ref=e171]:
                ...
                - listitem [ref=e174]: "발송 예정일: 09.17 (목) · CJ 대한통운"
        ...
        - generic [ref=e625]:
          - generic [ref=e626]:
            - img "text" [ref=e627]
            - generic [ref=e628]:
              - heading "원형 시트 스티커 FAQ" [level=2] [ref=e629]
              - paragraph [ref=e630]:
    ...
    - contentinfo [ref=e689]:
      - generic [ref=e690]:
        - generic [ref=e691]:
          - heading "MUSTICKER / 머스티커" [level=2] [ref=e692]
          - paragraph [ref=e693]: "상호명: (주)글로픽스"
          - paragraph [ref=e694]: "사업자등록번호 : 877-88-03313 통신판매업신고 : 2026-부산해운대-0792호"
          - paragraph [ref=e695]: "대표이사 : 여일석 주소 : 부산광역시 해운대구 해운대해변로 203 오션타워 1014호"
          - paragraph [ref=e696]: "호스팅사업자 : 아마존웹서비시즈(Amazon Web Services)"
          - paragraph [ref=e697]:
            - generic [ref=e698]: ⓒ 2026. All rights reserved.
            - generic [ref=e699]: "판매: sales@musticker.com"
            - link "이용약관" [ref=e700] [cursor=pointer]:
              - /url: /kr/terms-of-use
            - link "개인정보처리방침" [ref=e701] [cursor=pointer]:
              - /url: /kr/privacy-policy
            - button "사업자정보확인" [ref=e702] [cursor=pointer]
            - link "오픈소스 라이선스" [ref=e703] [cursor=pointer]:
              - /url: /kr/open-source-licenses
            - link "회사소개" [ref=e704] [cursor=pointer]:
              - /url: /kr/about
        - generic [ref=e705]:
          - paragraph [ref=e706]: 1899-5529
          - paragraph [ref=e708]: 오전 9시 ~ 오후 6시(토요일, 공휴일 휴무)
          - generic [ref=e709]:
            - button "1:1문의하기" [ref=e710] [cursor=pointer]
            - link "자주 묻는 질문" [ref=e711] [cursor=pointer]:
              - /url: /kr/faq
          - generic [ref=e712]:
            - generic [ref=e713]: "Follow us at:"
            - generic [ref=e714]:
              - link "instagram icon" [ref=e715] [cursor=pointer]:
                - /url: https://www.instagram.com/musticker_official/
                - img "instagram icon"
              - link "youtube icon" [ref=e716] [cursor=pointer]:
                - /url: https://www.youtube.com/@MustickerOfficial
                - img "youtube icon"
  - dialog [ref=e718]:
    - banner [ref=e719]:
      - heading "장바구니 미리보기 (1)" [level=3] [ref=e720]
      - button "쇼핑 계속하기" [ref=e721] [cursor=pointer]:
        - generic [ref=e722]:
          - paragraph [ref=e723]: 쇼핑 계속하기
          - img [ref=e724]
    - article [ref=e729]:
      - generic [ref=e730]:
        - img "illustrations/products/sheet-stickers/circle-sheet.svg" [ref=e732]
        - generic [ref=e733]:
          - heading "원형 시트 스티커" [level=4] [ref=e734]
          - paragraph [ref=e735]: "개별 사이즈: 30x30mm"
          - paragraph [ref=e736]: "수량: 5시트"
          - paragraph [ref=e737]: "소재: PVC 매트"
      - generic [ref=e738]:
        - strong [ref=e739]: 3,450원
        - generic [ref=e740]:
          - button "상품 수정" [ref=e741] [cursor=pointer]:
            - img [ref=e742]
            - generic [ref=e744]: 상품 수정
          - button "상품 삭제" [ref=e745] [cursor=pointer]:
            - img [ref=e746]
            - generic [ref=e748]: 상품 삭제
    - contentinfo [ref=e749]:
      - generic [ref=e750]:
        - paragraph [ref=e751]:
          - generic [ref=e752]: 합계
          - strong [ref=e753]: 3,450원
        - generic [ref=e754]:
          - paragraph [ref=e755]: 참고
          - paragraph [ref=e756]: 배송비 및 할인 내역은 결제 시 적용됩니다.
      - generic [ref=e757]:
        - button "장바구니 보기" [ref=e758] [cursor=pointer]:
          - generic [ref=e759]: 장바구니 보기
        - button "주문하기" [ref=e760] [cursor=pointer]:
          - generic [ref=e761]:
            - img [ref=e762]
            - text: 주문하기
  - dialog "사이즈 및 수량 수정" [ref=e764]:
    - banner [ref=e765]:
      - heading "사이즈 및 수량 수정" [level=3] [ref=e767]
      - button "모달 닫기" [ref=e769] [cursor=pointer]:
        - img [ref=e771]
    - generic [ref=e774]:
      - img "원형 시트 스티커" [ref=e776]
      - generic [ref=e777]:
        - generic [ref=e778]:
          - generic [ref=e779]:
            - generic [ref=e780]: 개별 사이즈
            - generic [ref=e781]: (단위:mm)
          - generic [ref=e782]:
            - button "Select option" [active] [ref=e783] [cursor=pointer]:
              - generic [ref=e784]: Select option
              - img [ref=e785]
            - listbox [ref=e786]:
              - paragraph [ref=e788]: No results found.
        - generic [ref=e789]:
          - generic [ref=e790]: 수량
          - button "Select option" [ref=e792] [cursor=pointer]:
            - generic [ref=e793]: Select option
            - img [ref=e794]
    - contentinfo [ref=e795]:
      - generic [ref=e796]:
        - button "취소" [ref=e797] [cursor=pointer]:
          - generic [ref=e798]: 취소
        - button "업데이트" [ref=e799] [cursor=pointer]:
          - generic [ref=e800]: 업데이트
```
...
```ts
  ...
  3  | 
  4  | import { ko } from '../fixtures/storefront-data.js';
  5  | 
  6  | // Shared by the cart preview drawer's 사이즈 및 수량 수정 dialog and the full cart page's 사이즈 변경
  7  | // dialog. Both surface the individual-size choice as a ui-select listbox rather than the product
  8  | // page's visible pill row, and both label the custom option 맞춤 사이즈 (not the product page's
  9  | // 원하는 크기 입력). The drawer's dialog also carries a second trigger for quantity, so the size
  10 | // trigger is always the first one.
  11 | export async function enterCartDialogCustomSize(
  12 |   page: Page,
  13 |   dialog: Locator,
  14 |   widthMm: number,
  15 |   heightMm: number
  16 | ): Promise<void> {
  17 |   await dialog.locator('button.cart-item-edit-select-trigger').first().click({ force: true });
  18 | 
  19 |   const listbox = page.getByRole('listbox').last();
  20 |   await expect(listbox).toBeVisible();
> 21 |   await listbox.getByText(ko.cartCustomSize).first().click({ force: true });
     |                                                      ^ Error: locator.click: Test timeout of 60000ms exceeded.
  22 | 
  23 |   // Unlike the size-guide modal's `#sheet-width`/`#sheet-height`, the cart dialogs render
  24 |   // `.cart-item-edit-inline-input` pairs pre-filled with the line item's current size.
  25 |   const width = dialog.locator('.cart-item-edit-inline-input').first();
  26 |   await expect(width).toBeVisible();
  27 |   await width.fill(String(widthMm));
  28 | 
  29 |   const height = dialog.locator('.cart-item-edit-inline-input').last();
  30 |   await height.fill(String(heightMm));
  31 |   await height.blur();
  32 | }
  33 | 
```