...
+   "[error] Failed to load resource: the server responded with a status of 403 ()",
+   "[error] TypeError: Failed to fetch dynamically imported module: https://www.musticker.com/_nuxt/CxuC5_qE.js",
+   "[error] [NUXT_E1005]",
+   "[error] Failed to load resource: the server responded with a status of 403 ()",
+   "[error] Failed to load resource: the server responded with a status of 403 ()",
...
+   "[error] Access to fetch at 'https://api.musticker.com/index.php/sys/kr/navigation/categories' from origin 'https://www.musticker.com' has been blocked by CORS policy: No 'Access-Control-Allow-Origin' header is present on the requested resource.",
+   "[error] Failed to load resource: net::ERR_FAILED",
+   "[error] Access to fetch at 'https://api.musticker.com/index.php/sys/kr/user/me?t=1789332234679' from origin 'https://www.musticker.com' has been blocked by CORS policy: No 'Access-Control-Allow-Origin' header is present on the requested resource.",
+   "[error] Failed to load resource: net::ERR_FAILED",
+   "[error] Access to fetch at 'https://api.musticker.com/index.php/sys/kr/user/me?t=1789332234679' from origin 'https://www.musticker.com' has been blocked by CORS policy: No 'Access-Control-Allow-Origin' header is present on the requested resource.",
+   "[error] Failed to load resource: net::ERR_FAILED",
+   "[error] [NUXT_E1005]",
...
+   "403 https://www.musticker.com/_nuxt/DotSMEcz.js",
+   "403 https://www.musticker.com/_nuxt/CXBjiHvQ.js",
...
- main [ref=e3]:
  ...
  - heading "Oops! We can’t find that page." [level=1] [ref=e6]
  - paragraph [ref=e7]: The page you’re looking for may have been moved or is no longer available.
  - button "Back to home" [active] [ref=e8] [cursor=pointer]:
    - img [ref=e9]
