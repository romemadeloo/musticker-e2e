    ...
    - generic [ref=e48]:
      ...
      - generic [ref=e625]:
        - generic [ref=e626]:
          - img "text" [ref=e627]
          - generic [ref=e628]:
            - heading "둥근 사각 판스티커 FAQ" [level=2] [ref=e629]
            - paragraph [ref=e630]:
        ...
        - generic [ref=e632]:
          - generic [ref=e633]:
            - generic [ref=e634] [cursor=pointer]:
              - heading "둥근사각형 시트 스티커란 무엇인가요?" [level=3] [ref=e635]
              - paragraph [ref=e638]: 둥근사각형 시트 스티커는 모서리가 둥글게 처리된 정사각형 또는 직사각형 스티커를 한 장의 시트에 배치해 제작하는 스티커입니다. 각 스티커는 키스컷 방식으로 제작되어 시트는 그대로 유지되며, 스티커를 한 장씩 쉽게 떼어 사용할 수 있습니다.
            - button [ref=e639] [cursor=pointer]:
              - img [ref=e640]
          - generic [ref=e642]:
            - generic [ref=e643] [cursor=pointer]:
              - heading "둥근사각형 시트 스티커는 어떤 소재를 선택할 수 있나요?" [level=3] [ref=e644]
              - paragraph [ref=e645]: 둥근사각형 시트 스티커는 PVC(백색), 투명, 홀로그램 소재로 제작할 수 있습니다. 선명한 색감을 원한다면 PVC(백색), 깔끔하고 자연스러운 느낌을 원한다면 투명, 반짝이는 효과를 원한다면 홀로그램을 추천합니다.
            - button [ref=e646] [cursor=pointer]:
              - img [ref=e647]
          - generic [ref=e649]:
            - generic [ref=e650] [cursor=pointer]:
              - heading "모서리의 둥근 정도를 선택할 수 있나요?" [level=3] [ref=e651]
              - paragraph [ref=e652]: 모서리의 둥근 정도는 상품 규격과 선택한 사이즈에 따라 달라집니다. 원하는 모서리 형태가 있는 경우에는 디자인 파일과 함께 요청 사항을 남겨 주시면 제작 전에 확인해 드립니다.
            - button [ref=e653] [cursor=pointer]:
              - img [ref=e654]
          - generic [ref=e656]:
            - generic [ref=e657] [cursor=pointer]:
              - heading "둥근사각형 시트 스티커는 쉽게 떼어 사용할 수 있나요?" [level=3] [ref=e658]
              - paragraph [ref=e659]: 네. 모든 스티커는 키스컷 방식으로 제작되어 시트에서 한 장씩 쉽게 떼어 사용할 수 있습니다. 둥근 모서리 덕분에 가장자리가 걸리는 현상을 줄여 더욱 편리하게 사용할 수 있습니다.
            - button [ref=e660] [cursor=pointer]:
              - img [ref=e661]
          - generic [ref=e663]:
            - generic [ref=e664] [cursor=pointer]:
              - heading "둥근사각형 시트 스티커는 방수 및 내구성이 있나요?" [level=3] [ref=e665]
              - paragraph [ref=e666]: 네. 머스티커의 둥근사각형 시트 스티커는 방수 기능이 있는 PVC 소재로 제작됩니다. 다만 날카로운 물체나 강한 마찰에는 긁힘이 생길 수 있으니 주의해 주세요.
