...
- Array []
+ Array [
+   "[error] Sheet previews request failed! D: API Response Contract Violation: Expected ApiResponse structure.
...
+     at async Object.d [as getSheetPreviews] (https://www.musticker.com/_nuxt/DkNnfi5K.js:1:2689)
+     at async d (https://www.musticker.com/_nuxt/CvstzpBQ.js:1:3858)",
...
- Array []
+ Array [
+   "500 https://api.musticker.com/index.php/sys/kr/shipping/production-estimates?product=die-cut-sticker",
+   "500 https://api.musticker.com/index.php/sys/kr/quote/die-cut-sticker/sheet-previews",
+ ]
```
